...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    ...
    if b == 0 {
        ...
        if a % b == 0 {
            ...
            // definie not devisible error
            let e = DivisionError::NotDivisible(NotDivisibleError {
                dividend : a,
                divisor : b,
            });
...
mod tests {
    ...
    fn result_with_list() {
        ...
        // collect the map into ONE results
        // pretty cool
        // https://doc.rust-lang.org/rust-by-example/error/iter_result.html
        let x = division_results.collect::<Result<Vec<i32>, _>>();

        //is the placeholder used by the Debug trait
    ...
    fn list_of_results() {
        let numbers = vec![27, 297, 38502, 81];
        let division_results = numbers.into_iter().map(|n| divide(n, 27));
        // collect the map into  vector of results
